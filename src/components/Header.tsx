...
const Header = () => {
  ...
  return <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${hasScrolled ? 'backdrop-blur-md shadow-lg bg-black/20' : 'bg-transparent shadow-none'}`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className={`flex justify-between items-center transition-all duration-300 ${hasScrolled ? 'h-12' : 'h-16'}`}>
          <div className="flex items-center">
            <div className="flex-shrink-0">
              <div className="flex items-center space-x-2">
                <img src="/lovable-uploads/febbaa6b-9b3b-4bec-b4ec-adb1d9efab32.png" alt="MULTIBPO Logo" className="h-8 w-auto" />
              </div>
            </div>
          </div>
          ...
          <div className="hidden md:block">
            <Button className="text-white hover:text-white bg-blue-800 hover:bg-blue-700">
              Começar Agora
            </Button>
          </div>
