...
const WhatsAppChat: React.FC<WhatsAppChatProps> = ({ activeCategory }) => {
  ...
  const chatScenarios = {
    vendas: [
      { text: "Olá! Gostaria de saber mais sobre os serviços contábeis", sender: 'user' as const },
      { text: "Olá! 😊 Seria um prazer ajudá-lo! Oferecemos consultoria contábil completa. Qual é o porte da sua empresa?", sender: 'bot' as const },
      { text: "Somos uma empresa de médio porte, cerca de 50 funcionários", sender: 'user' as const },
      { text: "Perfeito! Para empresas do seu porte, temos pacotes especiais que incluem:\n\n📊 Contabilidade completa\n💰 Planejamento tributário\n📈 Relatórios gerenciais\n\nGostaria de agendar uma apresentação?", sender: 'bot' as const },
      { text: "Sim, tenho interesse!", sender: 'user' as const },
      { text: "Excelente! 🎉 Vou transferir você para nosso especialista em vendas. Qual o melhor horário para contato?", sender: 'bot' as const }
    ],
    atendimento: [
      { text: "Preciso de ajuda com uma dúvida sobre minha declaração", sender: 'user' as const },
      { text: "Olá! Claro, estou aqui para ajudar! 📋 Pode me dar mais detalhes sobre sua dúvida?", sender: 'bot' as const },
      { text: "Não entendi uma informação no relatório mensal", sender: 'user' as const },
      { text: "Sem problemas! Posso explicar qualquer item do relatório. 📊\n\nVocê poderia me informar:\n• Qual seção específica?\n• Número do relatório?\n\nAssim posso te dar uma explicação detalhada!", sender: 'bot' as const },
      { text: "É sobre os impostos retidos na seção 3.2", sender: 'user' as const },
      { text: "Perfeito! 💡 Os impostos retidos na seção 3.2 referem-se aos valores que foram descontados na fonte. Vou enviar um documento explicativo e agendar uma reunião para esclarecer melhor. Pode ser amanhã às 14h?", sender: 'bot' as const }
    ],
    promocoes: [
      { text: "Oi", sender: 'user' as const },
      { text: "Olá! 🎉 Temos uma promoção especial este mês!\n\n🔥 50% OFF na primeira mensalidade\n📅 Consultoria gratuita\n🎁 Setup inicial sem custo\n\nVálido até o final do mês! Interessado?", sender: 'bot' as const },
      { text: "Que tipos de serviços estão inclusos?", sender: 'user' as const },
      { text: "Ótima pergunta! A promoção inclui:\n\n✅ Contabilidade digital completa\n✅ Emissão de guias e relatórios\n✅ Suporte via WhatsApp\n✅ Portal do cliente 24/7\n✅ Backup automático na nuvem\n\nTudo isso com 50% de desconto! 💰", sender: 'bot' as const },
      { text: "Sounds good! Como faço para contratar?", sender: 'user' as const },
      { text: "Maravilha! 🚀 É super simples:\n\n1️⃣ Cadastro online (2 min)\n2️⃣ Envio de documentos\n3️⃣ Setup da sua conta\n4️⃣ Começamos a trabalhar!\n\nVou te enviar o link para começar agora mesmo! 📲", sender: 'bot' as const }
    ]
  };
