...
const NewHero = () => {
  ...
  return <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 z-10">
        <Button onClick={scrollToNextSection} variant="ghost" size="icon" className="w-12 h-12 text-white transition-all animate-bounce rounded-none bg-transparent text-xl">
          <ChevronDown size={24} />
        </Button>
      </div>
    </section>;
