  ...
  return <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="max-w-2xl mx-auto mb-8">
          <div className="backdrop-blur-md border border-white/20 p-6 shadow-2xl px-[18px] rounded-3xl transition-all duration-300 group bg-black/40 hover:bg-black/60 py-[18px]">
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 z-10">
        <Button onClick={scrollToNextSection} variant="ghost" size="icon" className="w-9 h-9 text-white transition-all animate-bounce-slow rounded-full bg-transparent hover:bg-white/10">
          <ChevronDown size={20} />
        </Button>
      </div>
    </section>;
